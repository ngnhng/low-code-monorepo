...
export const FormUpdateRecord: ComponentConfig<FormUpdateProps> = {
    fields: {
        table: {
            type: "custom",
            label: "Select Table",
                                        ...
                                        ?.columns.map((column) => {
                                            return (
                                                column.name !== "idx" && (
                                                    <div
                                                        key={column.name}
                                                        className="flex flex-col items-start p-2.5 gap-2.5 bg-slate-200"
                                                    >
    ...
    render: ({ table, formName, workflowId, project }) => {
        const {
            tableData: { updateRow, fetchTablesByProjectId },
            ...
            switch (type) {
                ...
                default: {
                    if (table.sliderFields.some((field) => field.id === id)) {
                        const fieldProps = table.sliderFields.find(
                            (field) => field.id === id
                        );
                        return (
                            <Fragment key={id}>
