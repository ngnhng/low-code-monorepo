...
docker build -f ../../apiserver/auth-api/Dockerfile.dev -t yalc-auth-api:latest ../../apiserver/auth-api
docker tag yalc-auth-api:latest $REGISTRY_URL/yalc-auth-api:latest
docker push $REGISTRY_URL/yalc-auth-api:latest

docker build -f ../../apiserver/user-api/Dockerfile.dev -t yalc-user-api:latest ../../apiserver/user-api
