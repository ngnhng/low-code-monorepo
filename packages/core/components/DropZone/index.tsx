...
function DropZoneEdit({ zone, style }: DropZoneProps) {
    ...
    return (
        <div
            ...
            style={{
                zoom: 1 / (ctx.zoomLevel ?? 0.75),
            }}
        >
            <DroppableStrictMode droppableId={zoneCompound} direction={"vertical"} isDropDisabled={!isEnabled}>
                {(provided, snapshot) => {
                    return (
                        <div
                        ...
                        >
                            {content.map((item, i) => {
                                ...
                                const Render = config.components[item.type]
                                    ...
                                    : () => <div style={{ padding: 48, textAlign: "center" }}>No configuration for {item.type}</div>;
                                ...
                                return (
                                    <div key={item.props.id} className={getClassName("item")}>
                                        ...
                                        >
                                            ...
                                            >
                                                <div style={{ zoom: ctx.zoomLevel ?? 0.75 }}>
